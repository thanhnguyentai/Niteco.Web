module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        bowercopy: {
            ...
            deps: {
                files: {
                    ...
                    //'<%= project.dirs.scripts.bower %>/lodash.js': 'lodash/lodash.js',
                    ...
                    '<%= project.dirs.scripts.bower %>/mobile-detect.js': 'mobile-detect/mobile-detect.js',
                    '<%= project.dirs.scripts.bower %>/history.js': 'history.js/scripts/bundled-uncompressed/html5/jquery.history.js',
                    '<%= project.dirs.scripts.bower %>/requirejs-plugins/async.js': 'requirejs-plugins/src/async.js'
                }
            },
            fallbacks: {
                files: {
        ...
        htmllint: {
            ...
            all: {
                src: ['<%= project.dirs.static.main %>/*.html']
            }
        },
